...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <div class="row ">
            <div class="col-md-12">
                <div class="col-md-4" style="text-align: left;">
                    <button id="btnNewToolTag" class="btn btn-success Pos_Viewer" type="button">New</button>
                </div>

                <div class="col-md-8" style="text-align: right">
                    <button id="btnSubmitToolTag" class="btn btn-warning Pos_Viewer" type="button">Save</button>
                    <button id="btnSaveToolTag" class="btn btn-warning Pos_Viewer" type="button">Save</button>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="row" id="div-statusInActive">
                                <div class="col-md-6 col-xs-12">
                                    <div class="row form-group">
                                        <div class="col-md-3 col-xs-12">
                            ...
                            <div class="row">
                                <div class="col-md-6 col-xs-12">
                                    <div class="row form-group">
                                        ...
                                        <div class="col-md-8 col-xs-12">
                                            <div class="input-group">
                                                <input type="text" id="textAsset_No" class="form-control" style="min-width: 100%"
                                                    autocomplete="off" />
                                                <div class="input-group-btn">
                                                    <button class="btn btn-default  Browse_modal" data-type="AssetNumber"
                                                        type="button">
                                                        <i class="glyphicon glyphicon-search"></i>
                                                    </button>
                                                </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="row form-group">
                                                ...
                                                <div class="col-md-8 col-xs-8" style="text-align: right">
                                                    <button class="btn btn-success btnModal_Calibration Pos_Viewer" data-type="Calibration" data-action="New" type="button">New</button>
                                                </div>
                                            </div>
                                            <div class="row">
                                    ...
                                    <div class="panel-body">
                                        <div class="col-md-12">
                                            <div class="row form-group">
                                                ...
                                                <div class="col-md-8 col-xs-8" style="text-align: right">
                                                    <button class="btn btn-success btnModal_MA Pos_Viewer" data-type="Repair" data-action="New" type="button">New</button>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="table-responsive">
                                                    <table class="table table-hover table-bordered" id="tableMA" style="width: 100%">
                                                        ...
                                                        <tbody id="ListMA">
                                                            <tr>
                                                                ...
                                                                <td>25/09/2563</td>
                                                                <td>ดี</td>
                                                                <td><button type="button" class="btn btn-warning btnModal_MA" data-id="1" data-action="Edit">Edit</button></td>
                                                                <td><button type="button" class="btn btn-warning btnModal_MAReceive" data-id="1" data-action="Receive">Receive</button></td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                </div>
                                ...
                                <div class="panel-body">
                                    <div class="col-md-12">
                                        <div class="row ">
                                            ...
                                            <div class="col-md-12 form-group">
                                                <div class="col-md-3">
                                                    <label class="control-label" style="font-size: 13px">End date : </label>
                                                </div>
                                                <div class="col-md-9">
                                                    <div class="input-group">
                                        ...
                                        <div class="row ">
                                            ...
                                            <div class="col-md-12 form-group">
                                                ...
                                                <div class="col-md-9">
                                                    ...
                                                    <input id="textMA_Vendor_Code" class="form-control max-wide " style="display:none" type="text" autocomplete="off">
                                                </div>
                                            </div>
                                            <div class="col-md-12 form-group">
                                                <div class="col-md-3">
    ...
    <div class="modal fade" id="ModalReceive" role="dialog" data-backdrop="static" data-keyboard="false" style="align-content: center; margin-top: 15px;">
        <div class="modal-dialog modal-md" style="margin: auto;">
            <div class="modal-content">
                <div class="modal-header">
                    <div class="col-md-12 col-lg-12 col-sm-12">
                        <div class="col-md-7 col-lg-7 col-sm-12">
                            <h4 class="modal-title" id="ModalTitleReceive"></h4>
                        </div>
                        <div class="col-md-5 col-lg-5 col-sm-12" style="text-align: right;">
                            <button type="button" class="btn btn-warning" id="btnSaveReceive" data-attr="">Save</button>
                            <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                        </div>
                    </div>
                </div>
                ...
                <div class="modal-body" style="overflow-y: auto; max-height: 38em; max-width: 100%;">
                    <div class="panel-group">
                        <div class="col-md-12">
                            <div class="panel panel-primary">
                                <div class="panel-heading">
                                    <h4 style="font-weight: bold;">Receive</h4>
                                </div>
                                <div class="panel-body">
                                    <div class="col-md-12">
                                        <div class="row ">
                                            <div class="col-md-12 form-group" style="display:none">
                                                <div class="col-md-3">
                                                    <label class="control-label" style="font-size: 13px">Receive RepairType : </label>
                                                </div>
                                                <div class="col-md-9">
                                                    <input id="textReceive_RepairType" class="form-control max-wide " type="text" autocomplete="off" disabled>
                                                </div>
                                            </div>
                                            <div class="col-md-12 form-group" style="display:none">
                                                <div class="col-md-3">
                                                    <label class="control-label" style="font-size: 13px">Receive Ref MA_ID : </label>
                                                </div>
                                                <div class="col-md-9">
                                                    <input id="textReceive_refMA_ID" class="form-control max-wide " type="text" autocomplete="off" disabled>
                                                    <input id="textReceive_refPo_num" class="form-control max-wide " style="display:none" type="text" autocomplete="off" disabled>
                                                </div>
                                            </div>
                                            <div class="col-md-12 form-group">
                                                <div class="col-md-3">
                                                    <label class="control-label" style="font-size: 13px">Receive date : </label>
                                                </div>
                                                <div class="col-md-9">
                                                    <div class="input-group">
                                                        <input id="textReceive_Date" class="form-control max-wide " placeholder="dd/mm/yyyy" type="text" autocomplete="off">
                                                        <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-12 form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <select id="textReceive_Status" class="form-control max-wide">
                                                        <option value="Active">Active</option>
                                                        <option value="InActive">InActive</option>
                                                    </select>
                                                </div>
                                            ...
                                            <div class="col-md-12 form-group">
                                                <div class="col-md-3">
                                                    <label class="control-label" style="font-size: 13px">Status Tool:</label>
                                                </div>
                                                <div class="col-md-9">
                                                    <select id="textReceive_StatusTool" class="form-control max-wide">
                                            ...
                                            <div class="col-md-12 form-group">
                                                ...
                                                <div class="col-md-9 col-xs-12">
                                                    <div class="form-group">
                                                        <textarea class="form-control max-wide" id="textReceive_Remark" rows="3"></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            if (GETParams_ToolTag) {
                ...
                Get_VW_ToolsTag_Repair(GETParams_ToolTag);
                Get_TB_ToolTag_Calibration(GETParams_ToolTag);
                Get_TabHistory_VW_ToolTag_History(GETParams_ToolTag);
            ...
            $(document).on("click", ".btnModal_MA", function () {
                ...
                if (type == "New") {
                    ...
                    $("#textMA_Supplier").val('');
                    $("#textMA_Vendor_Code").val('');
                    $("#textMA_Cost").val('');
                    $("#textMA_PO_Number").val('');
                    $("#textMA_Remark").val('');
                    $("#textMA_RepairType").prop( "disabled", false );
            ...
            $(document).on("click", ".btnModal_Receive", function () {
                var id = $(this).attr("data-id");
                var tr = $(this).closest("tr");
                var RepairType = tr.find("td:nth-child(1)").text();
                var refPo_num = tr.find("td:nth-child(5)").text();
                $("#textReceive_refMA_ID").val(id);
                $("#textReceive_refPo_num").val(refPo_num);
                $("#textReceive_Date").val('');
                $("#textReceive_RepairType").val(RepairType);
                $("#textReceive_Status").val('Active');
                $("#textReceive_StatusTool").val('ดี');
                $("#textReceive_Remark").val('');

                $("#ModalTitleReceive").text('Receive');
            ...
            $(document).on("click", ".clickselecttext_ToolTag", function () {
                ...
                //Get_VW_ToolsTag_Repair(ToolTagCode);
            ...
            $(document).on("click", ".clickselecttext_PO_MA", function () {
                ...
                $("#textMA_Supplier").val(textVender_Name);
                $("#textMA_Vendor_Code").val(textVender);
                $("#textMA_Cost").val(textPurchase_Price);
                $("#modalBrowseSearch").modal("hide");
            });

            $(document).on("click", ".clickselecttext_AssetNumber", function () {
                var textAsset_No = $(this).closest("tr").find("td:nth-child(1)").text();
                $("#textAsset_No" ).val(textAsset_No);
                $("#modalBrowseSearch").modal("hide");
            });
                        ...
                        success: function (response) {
                            if (response.d.length > 0) {
                                $.each(response.d, function (index, val) {
                                    ...
                                    var poDate = val[12];
                                    fragment += '<tr>';
                                    fragment += '<td><a class="clickselecttext_PO_MA" href="javascript:void(0)">' + po_num + '</a></td>';
                                    fragment += '<td><a class="clickselecttext_PO_MA" href="javascript:void(0)">' + po_line + '</a></td>';
                                    fragment += '<td><a class="clickselecttext_PO_MA" href="javascript:void(0)">' + vend_num + '</a></td>';
                                    fragment += '<td><a class="clickselecttext_PO_MA" href="javascript:void(0)">' + vend_nane + '</a></td>';
                                    fragment += '<td><a class="clickselecttext_PO_MA" href="javascript:void(0)">' + poDate.substr(0,10) + '</a></td>';
                                    fragment += '<td><a class="clickselecttext_PO_MA" href="javascript:void(0)">' + item_cost_conv.split('.')[0] + '</a></td>';
            ...
            function ModalAssetNumber(search) {
                ...
                if (po_num == "") {
                    swal('Error', 'กรุณาตรวจสอบข้อมูล Po', 'error');
                } else {
                   $("#modalBrowseSearch").modal("show");
                }
                    ...
                    success: function (response) {
                        if (response.d.length > 0) {
                            ...
                            //,[Asset_No],[Serial_No],[Picture],[BUGroup],[PO_No],[Date_Purchase],[Calibration],[Calibration_Date],[GroupCode],[GroupName],[TypeCode],[TypeName],[SizeCode],[SizeName],[Location_Name]
                                ...
                                var SizeCode = val[23];
                                var SizeName = val[24];
                                var Location_Name = val[25];
                                var BUGroupName = val[26];
                                ...
                                $("#textDate_Inactive").val(Date_Inactive.substr(0,10));
                                ...
                                $("#textBUGroupName").val(BUGroupName);
                                //Show BUGroupName
                                $("#textPO_No").val(PO_No);
            ...
            $(document).on("click", "#btnSubmitToolTag", function () {
                ...
                console.log(Convert_Market_Price);
                    if (GroupCode != "" && TypeCode != ""  && Location != "") {
                        ...
                        swal('Error', 'กรุณาเลือก Group, Type, Size และ Location', 'error');
                    }
            });
            ...
            $(document).on("click", "#btnSaveCalibration", function () {
                ...
                var ToolTag_Code = $("#textToolTag_Code").val();
                if (StartCalibrationDate != "" && EndCalibrationDate != "") {
                    $.ajax({
                        type: "post",
                        async: false,
            ...
            $(document).on("click", "#btnSaveMA", function () {
                ...
                var vendor_Code = $("#textMA_Vendor_Code").val();
                ...
                var ToolTag_Code = $("#textToolTag_Code").val();
                var ReceiveDate = '';
                var StatusToolReturn = '';
                Cost = removeCurrency(Cost);
                //console.log(Cost);
                if (RepairType !="" && RepairDate!="") {
                    var check = SP_ToolTag_MA(ID, RepairType, RepairDate, vendor_Code, Cost, Remark, PO_Number
                        , ToolTag_Code, ReceiveDate, StatusToolReturn, site_ref, '','', Action)
                    //Update TB_ToolTag_MA 
                    if (check) {
                        if (Action == "Insert") {
                            SP_ToolTag_InserTranstion('Send Repair', RepairType, RepairDate,PO_Number,StatusToolReturn)
                            //Insert Transaction
                        }
                        Get_TabHistory_VW_ToolTag_History(ToolTag_Code)
                        Get_VW_ToolsTag_Repair(ToolTag_Code)
                        //Get Table
                        $("#ModalMA").modal("hide");
                        swal('Complete', 'บันทึกการ Repair สำเร็จ', 'success');
                    } else {
                        swal('Error', 'ไม่สำเร็จ กรุณาตรวจสอบข้อมูล', 'error');
                    }
                } else{
            ...
            $(document).on("click", "#btnSaveReceive", function () {
                var MA_ID = $("#textReceive_refMA_ID").val();
                var ReceiveDate = $("#textReceive_Date").val();
                var Status = $("#textReceive_Status").val();
                var StatusTool = $("#textReceive_StatusTool").val();
                var Remark = $("#textReceive_Remark").val();
                var RepairType = $("#textReceive_RepairType").val();
                var ToolTag_Code = $("#textToolTag_Code").val();
                var PO_Number = $("#textReceive_refPo_num").val();
                var Reason = $("#textReceive_StatusTool").val() == "ดี" ? "" : $("#textReceive_StatusTool").val();
                if (ReceiveDate != "") {
                    var check = SP_ToolTag_MA(MA_ID, '', '', '', 0, Remark, ''
                        , ToolTag_Code, ReceiveDate, StatusTool, site_ref, Status, Reason, 'Receive');
                    //Update TB_ToolTag_MA 
                    if (check) {
                        SP_ToolTag_InserTranstion('Receive Repair', RepairType, ReceiveDate,PO_Number,StatusTool);
                        //Insert Transaction
                        //Get_TabHistory_VW_ToolTag_History(ToolTag_Code)
                        //Get_VW_ToolsTag_Repair(ToolTag_Code)
                        //Get Table
                        $("#ModalReceive").modal("hide");
                        swal('Complete', 'บันทึกการ Receive สำเร็จ', 'success').then(function (confirm) {
                            if (confirm) {
                                location.reload();
                            }
                        });
                        ...
                        swal('Error', 'ไม่สำเร็จ กรุณาตรวจสอบข้อมูล', 'error');
                    }// Update TB_ToolTag_Ma Error
                } else {
                        swal('Error', 'ไม่สำเร็จ กรุณากรอกข้อมูลให้ครบถ้วน', 'error');
                }// ReceveDate is empty
               
            });
            //btn Save

            function SP_ToolTag_MA(ID, RepairType, RepairDate, Supplier, Cost, Remark, PO_Number
                , ToolTag_Code, ReceiveDate, StatusToolReturn,Site_ref,Status,Reason, Action) {
                var check = false;
                  $.ajax({
                    type: "post",
                    async: false,
                    ...
                    dataType: "json",
                    data: JSON.stringify({
                        ID: ID, RepairType: RepairType, RepairDate: RepairDate
                        , Supplier: Supplier, Cost: Cost, Remark: Remark, PO_No: PO_Number,
                        ToolTag_Code: ToolTag_Code, ReceiveDate: ReceiveDate,
                        StatusToolReturn: StatusToolReturn, Site_ref: Site_ref, Status: Status
            ...
            function SP_ToolTag_InserTranstion(  type,  RefType,  TransDate,PO_Number,StatusTool) { 
                var ToolTagCode = $("#textToolTag_Code").val();
                var BUGroup = $("#textBUGroup").val();
                var Location = $("#textLocation").val();
                $.ajax({
                    type: "post",
                    async: false,
                    url: "<%= ResolveUrl("Default.aspx/SP_ToolTag_InserTranstion") %>",
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    data: JSON.stringify({
                         SiteRef: site_ref
                        ...
                        if (response.d.length > 0) {
                            $.each(response.d, function (index, val) {
                                ...
                                tableCalibration.row.add([StartCalibrationDate.substr(0,10), EndCalibrationDate.substr(0,10), Detail,
                                    '<td><button type="button" class="btn btn-warning btnModal_Calibration Pos_Viewer" data-id="'+ID+'" data-action="Edit">Edit</button></td>']).draw().node();
                            });
                        }
                    }
                });
                    ...
                    success: function (response) {
                        if (response.d.length > 0) {
                            ...
                            $.each(response.d, function (index, val) {
                                ...
                                console.log(Path);
                                fragment += '<tr>';
                                fragment += '<td><a href="http://portalapp01/' + Path.substr(3) + '" target="_blank">' + showName.substr(12) + '</a></td>';
                                fragment += '<td></td>';
                                fragment += '<td><button type="button" class="btn btn-danger btnDeleteCB_Image Pos_Viewer" data-id="' + ID + '" data-Path="' + Path + '" ><i class="glyphicon glyphicon-trash" aria-hidden="true" style="color:white"></i></button></td>';
                                fragment += '</tr>';
            ...
            function Get_VW_ToolsTag_Repair(ToolTag_Code) {
                tableMA.clear().draw();
                $.ajax({
                    type: "post",
                    async: false,
                    url: "<%= ResolveUrl("Default.aspx/VW_ToolsTag_Repair") %>",
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    data: JSON.stringify({ ToolTag_Code: ToolTag_Code }),
                    success: function (response) {
                        if (response.d.length > 0) {
                            $.each(response.d, function (index, val) {
                                //[ID],[RepairType],[RepairDate],[Supplier],[Vendor_Name],[Cost]
                                //, [Remark], [PO_No], [ToolTag_Code], [ReceiveDate], [StatusToolReturn]
                                var ID = val[0];
                                var RepairType = val[1];
                                var RepairDate = val[2];
                                var Supplier = val[3];
                                var Vendor_Name = val[4];
                                var Cost = val[5];
                                var Remark = val[6];
                                var PO_No = val[7];
                                var ToolTag_Code = val[8];
                                var ReceiveDate = val[9];
                                var StatusToolReturn = val[10];
                                if (ReceiveDate != "") {
                                tableMA.row.add([
                                    RepairType
                                    , RepairDate.substr(0, 10)
                                    , Vendor_Name
                                    , Currency(Cost)
                                    , PO_No
                                    , Remark
                                    , ReceiveDate.substr(0,10)
                                    , StatusToolReturn
                                    ,'  '
                                    ,'  '
                                ]).draw().node();
                                ...
                                tableMA.row.add([
                                    ...
                                    , ''
                                    , StatusToolReturn
                                    ,'<td> <button type="button" class="btn btn-warning btnModal_MA Pos_Viewer" data-supplier="'+Supplier+'" data-id="' + ID + '" data-action="Edit">Edit</button></td > '
                                    ,'<td><button type="button" class="btn btn-info btnModal_Receive Pos_Viewer" data-supplier="'+Supplier+'" data-id="' + ID + '"  >Receive</button></td> '
                                ]).draw().node();
            ...
            function Get_TabHistory_VW_ToolTag_History(ToolTag_Code) {
                tableHistory.clear().draw();
                $.ajax({
                    type: "post",
                    async: false,
                    url: "<%= ResolveUrl("Default.aspx/TabHistory_VW_ToolTag_History") %>",
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    data: JSON.stringify({ ToolTag_Code: ToolTag_Code }),
                    success: function (response) {
                        if (response.d.length > 0) {
                            $.each(response.d, function (index, val) {
                                ...
                                tableHistory.row.add([Borrowfor,name, BorrowDate.substr(0, 10),
                                    ...
                                    '<a href="http://portalapp01/application_Software_Space/IC_InventoryControl/IC13_02%20-%20ToolRequest.aspx?WT=IC13_02&Site_Ref='+site_ref+'&ID='+WFIDBorrow+'&K2='+K2Borrow+'&TypeK2=K2&FlowType=M" target="_blank">' + K2Borrow + '<a/>'
                                    , ReturnDate.substr(0, 10),
                                    ...
                                    '<a href="http://portalapp01/application_Software_Space/IC_InventoryControl/IC13_02%20-%20ToolRequest.aspx?WT=IC13_02&Site_Ref='+site_ref+'&ID='+WFIDReturn+'&K2='+K2Return+'&TypeK2=K2&FlowType=M" target="_blank">' + K2Return + '<a/>'
            ...
            function SetDatePicker() {
                ...
                $('#textReceive_Date').datepicker({ format: 'dd/mm/yyyy', autoHide: true });
