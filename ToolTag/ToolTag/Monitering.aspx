<%@ Page Title="Monitering Calibration" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Monitering.aspx.cs" Inherits="ToolTag.Monitering_Calibration" %>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="col-12">
                                    <div class=" row ">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group col-md-6 col-xs-12">
                                                <span class="col-md-4 col-xs-12" style="font-weight: bold;">Type</span>
                                                <div class="col-md-8 col-xs-12">
                                                    <select id="textTrans_Type" class="form-control max-wide">
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="col-md-6">
                                                 <asp:Button runat="server" Text="Excel" OnClick="Export_Excel_Click" />
                                            </div>
                                        </div>
                                    </div>
                                    <!--panel-default-->
        ...
        $(document).ready(function () {
            ...
            function GetClibration(StartDate, StartEnd) {
                ...
                $.ajax({
                    ...
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    data: JSON.stringify({ StartDate: StartDate, StartEnd: StartEnd }),
                    success: function (response) {
                        if (response.d.length > 0) {
                            $.each(response.d, function (index, val) {
                                ...
                                var SizeCode = val[11];
                                var SizeName = val[12];
                                tableCalibration.row.add(['<a  href="./MaintainToolTag.aspx?ToolTag=' + ToolTag_Code + '" >' + ToolTag_Code + '</a>', GroupName, TypeName, SizeName, Brand, Model, StartCalibrationDate.substr(0, 10), EndCalibrationDate.substr(0, 10)]).draw().node();
                            });
                        }
                    }
                });
            ...
            function GetTransaction(Emp_Num, Costcenter, BU, ToolTag_Code, Type, Start_Date, End_Date) {
                ...
                $.ajax({
                    ...
                    dataType: "json",
                    data: JSON.stringify({
                        Emp_Num: Emp_Num, Costcenter: Costcenter, BU: BU, ToolTag_Code: ToolTag_Code, Type: Type, Start_Date: Start_Date, End_Date: End_Date
                    }),
                    success: function (response) {
                        if (response.d.length > 0) {
                            $.each(response.d, function (index, val) {
                                ...
                                tableTrans.row.add([Requestor
                                    ...
                                    , '<a href="http://pk-flow/application_Software_Space/IC-Item%20Code/IC13-ToolRequest.aspx?WT=IC13&Site_Ref=' + site_ref + '&ID=' + WFID + '&K2=' + K2ID + '&TypeK2=K2&FlowType=M" target="_blank">' + K2ID + '<a/>'
                                    , Status_Tool
