                    ...
                    <div class="panel-heading">
                        <div class="row">
                            ...
                            <div class="col-md-3 text-right">
                                <button type="button" class="btn btn-success btnGroup" data-type="Insert">Add</button>
                            </div>
                        </div>
                    </div>
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <div class="row">
                            ...
                            <div class="col-md-3 text-right">
                                <button type="button" class="btn btn-success btnModalType" data-type="Insert">Add</button>
                            </div>
                        </div>
                    </div>
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <div class="row">
                            ...
                            <div class="col-md-3 text-right">
                                <button type="button" class="btn btn-success btnModalSize" data-type="Insert">Add</button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12 col-lg-12 col-sm-12" style="margin-bottom: 1em;">
                            ...
                            <div class="col-md-5 col-sm-12" style="text-align: right;">
                                <button type="button" class="btn btn-success " id="btnSaveGroup" data-action="">Save</button>
                ...
                <div class="modal-header">
                    <div class="row">
                        <div class="col-md-12 col-lg-12 col-sm-12" style="margin-bottom: 1em;">
                            ...
                            <div class="col-md-5 col-sm-12" style="text-align: right;">
                                <button type="button" class="btn btn-success " id="btnSaveType" data-action="">Save</button>
                                <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                            </div>
                        </div>
                    </div>
                ...
                <div class="modal-header">
                    <div class="row">
                        <div class="col-md-12 col-lg-12 col-sm-12" style="margin-bottom: 1em;">
                            ...
                            <div class="col-md-5 col-sm-12" style="text-align: right;">
                                <button type="button" class="btn btn-success " id="btnSaveSize" data-action="">Save</button>
                                <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                            </div>
                        </div>
                    </div>
                            ...
                            $.each(response.d, function (index, val) {
                                ...
                                if (Status == "Active") {
                                    TableGroup_Active.row.add([
                                        ...
                                        column_GroupName,
                                        '<td> <button type="button" class="btn btn-warning btnGroup" data-type="Edit">Edit</button></td>',
                                        '<td><button type="button" class="btn btn-danger btnChangeStatus" data-id="' + GroupCode + '" data-maintype="Group" data-status="InActive">Deactivate</button></td>',
                                    ]).draw(false);
                                }
                                else {
                                    TableGroup_InActive.row.add([
                                        ...
                                        column_GroupName,
                                        '<td><button type="button" class="btn btn-warning btnGroup" data-type="Edit">Edit</button></td>',
                                        '<td><button type="button" class="btn btn-success btnChangeStatus" data-id="' + GroupCode + '" data-maintype="Group" data-status="Active">Activate</button></td>',
                                    ]).draw(false);
                                }
                            });
                        }
                            ...
                            $.each(response.d, function (index, val) {
                                ...
                                if (Status == "Active") {
                                    TableType_Active.row.add([
                                        ...
                                        '<td> <button type="button" class="btn btn-warning btnModalType" data-id="' + TypeCode + '" data-Calibration_Master="'+Calibration_Master+'" data-type="Edit">Edit</button></td>',
                                        '<td><button type="button" class="btn btn-danger btnChangeStatus" data-id="' + TypeCode + '"data-Calibration_Master="'+Calibration_Master+'"  data-maintype="Type"data-status="InActive">Deactivate</button></td>',
                                    ]).draw(false);
                                }
                                else {
                                    TableType_InActive.row.add([
                                        ...
                                        Checkbox_Calibration_Master,
                                        '<td><button type="button" class="btn btn-warning btnModalType" data-id="' + TypeCode + '" data-Calibration_Master="'+Calibration_Master+'" data-type="Edit">Edit</button></td>',
                                        ' <td><button type="button" class="btn btn-success btnChangeStatus" data-id="' + TypeCode + '"data-Calibration_Master="'+Calibration_Master+'"  data-maintype="Type" data-status="Active">Activate</button></td>',
                                    ]).draw(false);
                                }
                                //Add To Table
                            });
                            ...
                            $.each(response.d, function (index, val) {
                                ...
                                if (Status == "Active") {
                                    TableSize_Active.row.add([
                                        SizeName,
                                        '<td><button type="button" class="btn btn-warning btnModalSize" data-id="' + SizeCode + '" data-type="Edit">Edit</button></td>',
                                        '<td> <button type="button" class="btn btn-danger btnChangeStatus" data-id="' + SizeCode + '" data-maintype="Size" data-status="InActive">Deactivate</button></td>',
                                    ]).draw(false);
                                }
                                else {
                                    TableSize_InActive.row.add([
                                        SizeName,
                                        '<td><button type="button" class="btn btn-warning btnModalSize" data-id="' + SizeCode + '" data-type="Edit">Edit</button></td>',
                                        '<td> <button type="button" class="btn btn-success btnChangeStatus" data-id="' + SizeCode + '" data-maintype="Size"data-status="Active">Activate</button></td>',
                                    ]).draw(false);
                                }
                            });
                        }
