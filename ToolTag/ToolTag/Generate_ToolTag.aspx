                                ...
                                <div class="panel panel-default" style="margin-top: 1em;">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div style="text-align: right">
                                            <button id="nextPage2" class="btn btn-warning" type="button"
        ...
        $(document).ready(function () {
            ...
            $(document).on("click", "#nextPage3", function () {
                ...
                if (textQTY != "") {
                    ...
                    swal('Error', 'กรุณา เลือก PO', 'error');
                }
            });
                ...
                for (i = 0; i < textQTY; i++) {
                    fragment += `      <div class="col-md-12 col-sm-12 div_ALLSerial" style="margin-bottom: 1em;">
                                                    ...
                                                    <div class="col-md-6 col-sm-12">
                                                        ...
                                                        <div class="col-md-6">
                                                            <input type="text" class="fill_Asset_No form-control " style="min-width: 100%" autocomplete="off" />
                                                        </div>
                                                    </div>
                                                </div>`;
                    num++;
